...
* [動手玩 Java 專案建置工具：以 Gradle 與 Docker 為例](http://jcconf.tw/speaker/play-java-with-gradle-and-docker.html)（發表於 [JCConf 2015](http://jcconf.tw/schedule.html) 由社群主辦 Java 開發者年會）
